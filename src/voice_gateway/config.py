...
class Settings:
    ...
    tts_queue_max_concurrent: int = field(default_factory=lambda: _env_int("TTS_QUEUE_MAX_CONCURRENT", 1, 1, 64))
    tts_queue_max_pending: int = field(default_factory=lambda: _env_int("TTS_QUEUE_MAX_PENDING", 32, 0, 10000))
    tts_queue_timeout_seconds: float = field(default_factory=lambda: _env_float("TTS_QUEUE_TIMEOUT_SECONDS", 120.0, 0.1, 3600.0))
